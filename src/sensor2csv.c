...
// and list available serial ports
  ...
  if (argc<2) {
    ...
    fprintf(stderr,"  sensor2csv serial-port csv-file-name [baud]\n");
    fprintf(stderr,"note:\n");
